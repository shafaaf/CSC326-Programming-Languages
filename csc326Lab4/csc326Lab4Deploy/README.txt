...
AWS instance installation, termination etc:
All deployment, termination, AWS EC2 code is in deployments folder/ 
For one click deployment - oneClickDeployment.py
For termination - terminateInstance.py
